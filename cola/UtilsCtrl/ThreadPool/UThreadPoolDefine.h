 ...
 * @Version      : 0.0.1
 * @LastEditors  : naonao
 * @LastEditTime : 2024-11-15 14:16:17
 **/
...
static const NInt NAO_CPU_NUM               = (NInt)std::thread::hardware_concurrency();
...
static const NInt NAO_THREAD_SCHED_OTHER = 0;
static const NInt NAO_THREAD_SCHED_RR    = 0;
static const NInt NAO_THREAD_SCHED_FIFO  = 0;
#endif
...
static const NInt  NAO_MAX_THREAD_SIZE               = 8;                        // 最大线程个数
static const NInt  NAO_MAX_TASK_STEAL_RANGE          = 7;                        // 盗取机制相邻范围
...
static const NInt  NAO_PRIMARY_THREAD_BUSY_EPOCH     = 5;                        // 主线程进入wait状态的轮数，数值越大，理论性能越高，但空转可能性也越大
static const NMSec NAO_PRIMARY_THREAD_EMPTY_INTERVAL = 1000;                     // 主线程进入休眠状态的默认时间
...
static const NMSec NAO_QUEUE_EMPTY_INTERVAL          = 1000;                       // 队列为空时，等待的时间。仅针对辅助线程，单位为ms
