/**
 * @FilePath     : /cola/cola/UtilsCtrl/Timer/UTimer.h
 * @Description  :
 * @Author       : naonao
 * @Version      : 0.0.1
 * @LastEditors  : naonao
 * @LastEditTime : 2024-11-17 10:42:56
 * @Copyright    :
 **/
#ifndef NAO_UTIMER_H
#define NAO_UTIMER_H
...
public:
    ...
    NVoid start(NMSec interval, const TTask& task, const TMod& modify)
    {
...
private:
    std::atomic<NBool>      is_stop_{true};
    std::mutex              mutex_;
